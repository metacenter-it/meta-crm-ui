...
import QuoteRotator from "@/components/shared/QuoteRotator.vue";
import Logo from "@/assets/LogoMeta.svg";
</script>
<template>
  <!-- Login 9 - Bootstrap Brain Component -->
  <section class="bg-primary-override py-3 py-md-5 py-xl-8">
        ...
        <div class="col-12 col-md-6 col-xl-7">
          <div class="d-flex justify-content-center text-bg-primary">
            <div class="col-12 col-xl-9">
              ...
              <h2 class="h2 mb-4 text-white">Hola, Bienvenido</h2>
              <QuoteRotator></QuoteRotator>
              <div class="text-endx text-white">
                <svg
              ...
              <form action="#!">
                <div class="row gy-3 overflow-hidden">
                  ...
                  <div class="col-12">
                    <div class="d-grid">
                      <RouterLink
                        class="btn btn-primary btn-lg bg-primary-override"
                        type="submit"
                        to="/home"
                      >
                        Log in now
